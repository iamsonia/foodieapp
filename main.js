...
$scope.restaurants = [{
	name: 'jai hind',
	address: 'bhudiyo road, Near busstop Mulana',
	location: 'Mulana,Haryana',
...
{
  name: 'Saini Sweets',
  address: 'Dvarkapuri Chowk,Yamuna nagar',
  location: 'Jgadhari,Haryana',
  category: 'Indian Food',
  vote: '4.7',
  cuisines: 'Indian,Fast Food',
  cost: '900',
  hours: '8:00 PM to 11:45 PM',
  ...
  name: 'Hans Sweets House',
  address: 'Near Saini Hospital Pehowa Road',
  location: 'Ismailabad,Haryana',
